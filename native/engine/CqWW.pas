...
type
  ...
  public
    ...
    class function compareCall({$ifdef FPC}constref{$else}const{$endif} left, right: TCqWwCallRec) : integer; static;
  end;
...
class function TCqWwCallRec.compareCall({$ifdef FPC}constref{$else}const{$endif} left, right: TCqWwCallRec) : integer;
begin
