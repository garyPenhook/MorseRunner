...
uses
  ExchFields,
  SysUtils, RndFunc, Ini, MorseKey, Contest, {$ifdef FPC}Globals{$else}Main{$endif}, DXCC;
...
begin
  ...
  if Envelope = nil then
    ...
    {$ifdef FPC}if Assigned(Globals.GAdvanceProc) then Globals.GAdvanceProc(){$else}MainForm.Advance{$endif};
    end;
end;
