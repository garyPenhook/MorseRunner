...
uses
  {$ifdef MSWINDOWS}Windows, Messages, Graphics, Controls, Forms, Dialogs,{$endif}
  SysUtils, Classes,
  SndTypes, Math;
...
begin
  ...
  // Leave a small digital headroom margin while making better use of the
  // 16-bit output range. The PulseAudio backend normalises these samples.
  FMaxOut := 30000;
  FNoiseIn := 1;
  FNoiseOut := 2000;
  CalcBeta;
