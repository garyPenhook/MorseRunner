...
type
  ...
  TExchange1Type = (etNoExch1, etRST, etOpName, etFdClass,
                    etSSNrPrecedence);

  // Exchange Field #2 Types
  TExchange2Type = (etNoExch2, etSerialNr, etGenericField, etArrlSection, etStateProv,
...
{$ifdef FPC}
  // Pair of exchange field types (sent or received) for a station in a contest
  TExchTypes = record
    Exch1: TExchange1Type;
    Exch2: TExchange2Type;
