...
`MASTER.SCP` is a content-preserving snapshot of Super Check Partial's public
contest callsign list, retrieved on 2026-08-10 from
...
network connection. Its line endings are normalized to LF for clean Git
history; its header and callsign records are unchanged.
